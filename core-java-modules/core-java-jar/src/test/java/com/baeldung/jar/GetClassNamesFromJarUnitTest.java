...
public class GetClassNamesFromJarUnitTest {
    private static final String JAR_PATH = "example-jar/stripe-0.0.1-SNAPSHOT.jar.foo";
    ...
    public void givenJarFilePath_whenLoadClassNames_thenGetClassNames() throws IOException, URISyntaxException {
        ...
        Set<String> classNames = GetClassNamesFromJar.getClasseNamesFromJarFile(jarFile);
